...
TEST(ElemMatchObjectMatchExpression, MatchesElementMultiple) {
    ...
    unique_ptr<ComparisonMatchExpression> eq1(new EqualityMatchExpression(nullptr));
    ASSERT(eq1->init("b", baseOperand1["b"]).isOK());
    unique_ptr<ComparisonMatchExpression> eq2(new EqualityMatchExpression(nullptr));
    ASSERT(eq2->init("b", baseOperand2["b"]).isOK());
    unique_ptr<ComparisonMatchExpression> eq3(new EqualityMatchExpression(nullptr));
...
TEST(ElemMatchValueMatchExpression, MatchesElementSingle) {
    ...
    unique_ptr<ComparisonMatchExpression> gt(new GTMatchExpression(nullptr));
...
TEST(AndOfElemMatch, MatchesElement) {
    ...
    unique_ptr<ComparisonMatchExpression> eqa1(new EqualityMatchExpression(nullptr));
    ASSERT(eqa1->init("a", baseOperanda1["a"]).isOK());

    BSONObj baseOperandb1 = BSON("b" << 1);
    unique_ptr<ComparisonMatchExpression> eqb1(new EqualityMatchExpression(nullptr));
    ...
    unique_ptr<ComparisonMatchExpression> eqa2(new EqualityMatchExpression(nullptr));
    ASSERT(eqa2->init("a", baseOperanda2["a"]).isOK());

    BSONObj baseOperandb2 = BSON("b" << 2);
    unique_ptr<ComparisonMatchExpression> eqb2(new EqualityMatchExpression(nullptr));
...
TEST(AndOfElemMatch, Matches) {
    ...
    unique_ptr<ComparisonMatchExpression> gt1(new GTMatchExpression(nullptr));
    ASSERT(gt1->init("", baseOperandgt1["$gt"]).isOK());

    BSONObj baseOperandlt1 = BSON("$lt" << 10);
    unique_ptr<ComparisonMatchExpression> lt1(new LTMatchExpression(nullptr));
    ...
    unique_ptr<ComparisonMatchExpression> gt2(new GTMatchExpression(nullptr));
    ASSERT(gt2->init("", baseOperandgt2["$gt"]).isOK());

    BSONObj baseOperandlt2 = BSON("$lt" << 110);
    unique_ptr<ComparisonMatchExpression> lt2(new LTMatchExpression(nullptr));
